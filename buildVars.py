...
addon_info = AddonInfo(
	...
	addon_summary=_("ClauVDA (Anthropic Claude AI NVDA)"),
	# Add-on description
...
Supports Claude Opus 4.7, Sonnet 4.6, and Haiku 4.5 for chat, image description, and more."""),
	...
	addon_url="https://github.com/ogomez92/claudeNVDA",
	# URL for the add-on repository where the source code can be found
	addon_sourceURL="https://github.com/ogomez92/claudeNVDA",
...
pythonSources: list[str] = [
	"addon/globalPlugins/ClauVDA/*.py",
]
